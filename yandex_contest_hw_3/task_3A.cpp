/*
 ...
 Формат ввода
 Программа получает на вход натуральные числа n и m, не превосходящие 100. Далее идет n строк,
 ...
 Примечания
 Ряды нумеруются с единицы "сверху вниз", то есть, сначала описаны места в первом ряду, потом - во втором, и т. д.
*/
